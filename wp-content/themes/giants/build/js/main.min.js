...
var GiantsSite={page:{init:function(){function i(){var i=parseInt($(window).height(),0),e=(parseInt($(window).width(),0),parseInt($(window).scrollTop(),0));$(".touch-slider .slick-item").each(function(){var o=$(this),t=$(o).offset(),a=e-(t.top-i);if(a>0){var n=100-a/i*100;$(o).css("background-position","center "+n+"%")}}),$(".slick-gallery .slick-item").each(function(){var o=$(this),t=$(o).offset(),a=e-(t.top-i);if(a>0){var n=150-a/i*100;$(o).css("background-position","center "+n+"%")}})}$("scrollHP").slick({dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:6e3,pauseOnHover:!1,speed:600}),$(".slick-gallery").slick({dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:6e3,pauseOnHover:!1,speed:600}).on("click",function(){$(".slick-gallery").slick("slickPause")}),$(window).scroll(function(){i()}),$(window).load(function(){i(),$(".slick-gallery").addClass("on")}),$(".trigger-modal").click(function(){return $("#modal").modal(),$("iframe#ytplayer").attr("src",$("iframe#ytplayer").attr("src").replace("autoplay=0","autoplay=1")),!1})},finalize:function(){}},gallery:{init:function(){},finalize:function(){}},single:{init:function(){function i(){var i=parseInt($(window).height(),0),e=(parseInt($(window).width(),0),parseInt($(window).scrollTop(),0));$(".touch-slider .slick-item").each(function(){var o=$(this),t=$(o).offset(),a=e-(t.top-i);if(a>0){var n=100-a/i*100;$(o).css("background-position","center "+n+"%")}}),$(".slick-gallery .slick-item").each(function(){var o=$(this),t=$(o).offset(),a=e-(t.top-i);if(a>0){var n=150-a/i*100;$(o).css("background-position","center "+n+"%")}{var l=o.data("slide"),s=o.data("img");o.data("layout")}o.find(".overlay-left").html(l),""!=s&&o.find(".overlay-right").html('<img src="'+s+'" />')})}$(".slick").slick({slidesToShow:2,arrows:!0,pauseOnHover:!1,dot:!1}),$(".slick-gallery").slick({dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:6e3,pauseOnHover:!1,speed:600}),$(".trigger-modal").click(function(){return $("#modal").modal(),$("iframe#ytplayer").attr("src",$("iframe#ytplayer").attr("src").replace("autoplay=0","autoplay=1")),!1}),$(window).scroll(function(){i()}),$(window).load(function(){i(),$(".slick-gallery").addClass("on")})},finalize:function(){}}},UTIL={fire:function(i,e,o){var t=GiantsSite;e=void 0===e?"init":e,""!==i&&t[i]&&"function"==typeof t[i][e]&&t[i][e](o)},loadEvents:function(){UTIL.fire("common"),$.each(document.body.className.replace(/-/g,"_").split(/\s+/),function(i,e){UTIL.fire(e)}),UTIL.fire("common","finalize")}};$(document).ready(UTIL.loadEvents),function(){function i(){var i=parseInt($(window).scrollTop(),0),e=$(window).width();e>768&&(i>0?$("body").addClass("scrolled"):$("body").removeClass("scrolled"))}function e(){if($("#Timeline").length){var i=parseInt($(window).height(),0),e=parseInt($(window).scrollTop(),0);$("#Timeline .item").each(function(){var o=$(this),t=$(o).offset(),a=e-(t.top-i);if(a>0){var n=100-a/i*100;50>n?$(o).addClass("animate"):n>50&&$(this).removeClass("animate")}});var o=$("#Timeline").offset(),t=o.top+$("#Timeline").height();e>t?$("#Timeline").addClass("removescroll"):$("#Timeline").removeClass("removescroll")}}$(window).scroll(function(){i(),e()}),$(window).resize(function(){i()}),$(window).load(function(){i(),e()}),$("a[href*=#]:not([href=#])").click(function(){if(console.log("this.hash.slice(1)"),location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){$("#submenu li").removeClass("current_page_item"),$(this).parent().addClass("current_page_item");var i=$(this.hash),e=1e3;if(i=i.length?i:$("[id="+this.hash.slice(1)+"]"),i.length)return $("html,body").animate({scrollTop:i.offset().top-e},800),!1}})}(jQuery);