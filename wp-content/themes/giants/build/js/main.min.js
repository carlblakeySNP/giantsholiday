...
var GiantsSite={page:{init:function(){function i(){var i=parseInt($(window).height(),0),e=(parseInt($(window).width(),0),parseInt($(window).scrollTop(),0));$(".touch-slider .slick-item").each(function(){var t=$(this),o=$(t).offset(),n=e-(o.top-i);if(n>0){var a=100-n/i*100;$(t).css("background-position","center "+a+"%")}}),$(".slick-gallery .slick-item").each(function(){var t=$(this),o=$(t).offset(),n=e-(o.top-i);if(n>0){var a=150-n/i*100;$(t).css("background-position","center "+a+"%")}})}$("scrollHP").slick({dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:6e3,pauseOnHover:!1,speed:600}),$(".slick-gallery").slick({dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:6e3,pauseOnHover:!1,speed:600}).on("click",function(){$(".slick-gallery").slick("slickPause")}),$(window).scroll(function(){i()}),$(window).load(function(){i(),$(".slick-gallery").addClass("on")}),$(".trigger-modal").click(function(){return $("#modal").modal(),$("iframe#ytplayer").attr("src",$("iframe#ytplayer").attr("src").replace("autoplay=0","autoplay=1")),!1})},finalize:function(){}},gallery:{init:function(){},finalize:function(){}},single:{init:function(){function i(){var i=parseInt($(window).height(),0),e=(parseInt($(window).width(),0),parseInt($(window).scrollTop(),0));$(".touch-slider .slick-item").each(function(){var t=$(this),o=$(t).offset(),n=e-(o.top-i);if(n>0){var a=100-n/i*100;$(t).css("background-position","center "+a+"%")}}),$(".slick-gallery .slick-item").each(function(){var t=$(this),o=$(t).offset(),n=e-(o.top-i);if(n>0){var a=150-n/i*100;$(t).css("background-position","center "+a+"%")}{var s=t.data("slide"),l=t.data("img");t.data("layout")}t.find(".overlay-left").html(s),""!=l&&t.find(".overlay-right").html('<img src="'+l+'" />')})}$(".slick").slick({slidesToShow:2,arrows:!0,pauseOnHover:!1,dot:!1}),$(".slick-gallery").slick({dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:6e3,pauseOnHover:!1,speed:600}),$(".trigger-modal").click(function(){return $("#modal").modal(),$("iframe#ytplayer").attr("src",$("iframe#ytplayer").attr("src").replace("autoplay=0","autoplay=1")),!1}),$(window).scroll(function(){i()}),$(window).load(function(){i(),$(".slick-gallery").addClass("on")})},finalize:function(){}}},UTIL={fire:function(i,e,t){var o=GiantsSite;e=void 0===e?"init":e,""!==i&&o[i]&&"function"==typeof o[i][e]&&o[i][e](t)},loadEvents:function(){UTIL.fire("common"),$.each(document.body.className.replace(/-/g,"_").split(/\s+/),function(i,e){UTIL.fire(e)}),UTIL.fire("common","finalize")}};$(document).ready(UTIL.loadEvents),function(){function i(){var i=parseInt($(window).scrollTop(),0),e=$(window).width();e>768&&(i>45?($("#site-navigation").css({position:"fixed",top:0}),$(".submenu-wrap").css({marginTop:"44px"}),$(".site-branding").css({height:"40px"})):($("#site-navigation").css({position:"absolute",top:35}),$(".submenu-wrap").css({marginTop:"65px"}),$(".site-branding").css({height:"84px"})),$(".site-branding").css(i>0?{top:5}:{top:20}))}function e(){if($("#Timeline").length){var i=parseInt($(window).height(),0),e=parseInt($(window).scrollTop(),0);$("#Timeline .item").each(function(){var t=$(this),o=$(t).offset(),n=e-(o.top-i);if(n>0){var a=100-n/i*100;50>a?$(t).addClass("animate"):a>50&&$(this).removeClass("animate")}});var t=$("#Timeline").offset(),o=t.top+$("#Timeline").height();e>o?$("#Timeline").addClass("removescroll"):$("#Timeline").removeClass("removescroll")}}$(window).scroll(function(){i(),e()}),$(window).resize(function(){i()}),$(window).load(function(){i(),e()}),$("a[href*=#]:not([href=#])").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){$("#submenu li").removeClass("current_page_item"),$(this).parent().addClass("current_page_item");var i=$(this.hash),e=100;if(console.log(this.hash.slice(1)),i=i.length?i:$("[id="+this.hash.slice(1)+"]"),i.length)return $("html,body").animate({scrollTop:i.offset().top-e},800),!1}})}(jQuery);