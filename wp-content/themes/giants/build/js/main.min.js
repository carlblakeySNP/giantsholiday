...
var GiantsSite={page:{init:function(){function i(){var i=parseInt($(window).height(),0),t=(parseInt($(window).width(),0),parseInt($(window).scrollTop(),0));$(".touch-slider .slick-item").each(function(){var a=$(this),o=$(a).offset(),n=t-(o.top-i);if(n>0){var e=100-n/i*100;$(a).css("background-position","center "+e+"%")}}),$(".slick-gallery .slick-item").each(function(){var a=$(this),o=$(a).offset(),n=t-(o.top-i);if(n>0){var e=150-n/i*100;$(a).css("background-position","center "+e+"%")}})}$("scrollHP").slick({dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:6e3,pauseOnHover:!1,speed:600}),$(".slick-gallery").slick({dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:6e3,pauseOnHover:!1,speed:600}).on("click",function(){$(".slick-gallery").slick("slickPause")}),$(window).scroll(function(){i()}),$(window).load(function(){i(),$(".slick-gallery").addClass("on")}),$(".trigger-modal").click(function(){return $("#modal").modal(),$("iframe#ytplayer").attr("src",$("iframe#ytplayer").attr("src").replace("autoplay=0","autoplay=1")),!1})},finalize:function(){}},gallery:{init:function(){},finalize:function(){}},single:{init:function(){function i(){var i=parseInt($(window).height(),0),t=(parseInt($(window).width(),0),parseInt($(window).scrollTop(),0));$(".touch-slider .slick-item").each(function(){var a=$(this),o=$(a).offset(),n=t-(o.top-i);if(n>0){var e=100-n/i*100;$(a).css("background-position","center "+e+"%")}}),$(".slick-gallery .slick-item").each(function(){var a=$(this),o=$(a).offset(),n=t-(o.top-i);if(n>0){var e=150-n/i*100;$(a).css("background-position","center "+e+"%")}{var s=a.data("slide"),r=a.data("img");a.data("layout")}a.find(".overlay-left").html(s),""!=r&&a.find(".overlay-right").html('<img src="'+r+'" />')})}$(".slick").slick({slidesToShow:2,arrows:!0,pauseOnHover:!1,dot:!1}),$(".slick-gallery").slick({dots:!0,arrows:!1,autoplay:!0,autoplaySpeed:6e3,pauseOnHover:!1,speed:600}),$(".trigger-modal").click(function(){return $("#modal").modal(),$("iframe#ytplayer").attr("src",$("iframe#ytplayer").attr("src").replace("autoplay=0","autoplay=1")),!1}),$(window).scroll(function(){i()}),$(window).load(function(){i(),$(".slick-gallery").addClass("on")})},finalize:function(){}}},UTIL={fire:function(i,t,a){var o=GiantsSite;t=void 0===t?"init":t,""!==i&&o[i]&&"function"==typeof o[i][t]&&o[i][t](a)},loadEvents:function(){UTIL.fire("common"),$.each(document.body.className.replace(/-/g,"_").split(/\s+/),function(i,t){UTIL.fire(t)}),UTIL.fire("common","finalize")}};$(document).ready(UTIL.loadEvents),function(){function i(){var i=parseInt($(window).scrollTop(),0),t=$(window).width();t>768&&(i>45?($("#site-navigation").css({position:"fixed",top:0}),$(".submenu-wrap").css({marginTop:"44px"}),$(".site-branding").css({height:"40px"})):($("#site-navigation").css({position:"absolute",top:35}),$(".submenu-wrap").css({marginTop:"65px"}),$(".site-branding").css({height:"84px"})),$(".site-branding").css(i>0?{top:5}:{top:20}))}function t(){var i=parseInt($(window).height(),0),t=parseInt($(window).scrollTop(),0);$("#Timeline .item").each(function(){var a=$(this),o=$(a).offset(),n=t-(o.top-i);if(n>0){var e=100-n/i*100;50>e?$(a).addClass("animate"):e>50&&$(this).removeClass("animate")}})}$(window).scroll(function(){i(),t()}),$(window).resize(function(){i()}),$(window).load(function(){i(),t()}),$("a[href*=#]:not([href=#])").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){$("#submenu li").removeClass("current_page_item"),$(this).parent().addClass("current_page_item");var i=$(this.hash),t=100;if(console.log(this.hash.slice(1)),i=i.length?i:$("[id="+this.hash.slice(1)+"]"),i.length)return $("html,body").animate({scrollTop:i.offset().top-t},800),!1}})}(jQuery);