                ...
                <?php else: ?>
                    <div class="grid video-play">
                        ...
                        <div class="block-2">
                                ...
                                <p><?php echo $post_type->post_excerpt; ?></p>
...
<div id="experience"></div>
    <?php if( have_rows('text_slideshow') ): ?>
        ...
        <div class="large-feature" style="background-image: url(<?php echo $image['sizes']['slideshow']; ?>);">
            <div class="container">
                <div class="box">
...
<div id="events"></div>
    ...
    <?php if( have_rows('multiple_galleries') ): ?>
       <div class="gray-background addons yachtgallery">
            <div class="container">
                ...
                <?php while ( have_rows('multiple_galleries') ) : the_row(); ?>
                    ...
                    <?php 
                        ...
                        array_push($images, $imgArray['url']);
                    ?>
                    <?php endwhile; ?>
                    <?php 
